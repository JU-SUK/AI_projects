...
# Apply 2 hidden layers as MLP neuron1: 512, neuron2: 512
network.fc = nn.Sequential(nn.Linear(512,512), nn.Linear(512,512),nn.Linear(512,100))
network.fc[0].add_module('dropout',nn.Dropout(0.5))
network.fc[1].add_module('dropout',nn.Dropout(0.5))
